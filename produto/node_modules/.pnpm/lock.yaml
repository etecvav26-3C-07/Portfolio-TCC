  ...
  .:
    ...
    devDependencies:
      vitepress:
        ...
        version: 2.0.0-alpha.20(postcss@8.5.28)
...
packages:
  ...
  google-translate-api-x@10.7.3:
    resolution: {integrity: sha512-UCLhGMyzUiQQJuUjw6KM4scl4WJjMq5kYbq3eqLHB0KB96XBQ+VV7L/NUpJ9eMfVxXswXxA6xWhAX1h1OdDLZg==}
    engines: {node: '>=21.0.0'}
...
snapshots:
  ...
  '@vitejs/plugin-vue@6.0.8(vite@8.3.0)(vue@3.5.42)':
    dependencies:
      '@rolldown/pluginutils': 1.0.1
      vite: 8.3.0
      vue: 3.5.42
  ...
  '@vueuse/integrations@14.4.0(focus-trap@8.2.2)(vue@3.5.42)':
    dependencies:
      '@vueuse/core': 14.4.0(vue@3.5.42)
      '@vueuse/shared': 14.4.0(vue@3.5.42)
      vue: 3.5.42
  ...
  vitepress@2.0.0-alpha.20(postcss@8.5.28):
    dependencies:
      '@docsearch/css': 4.7.0
      '@docsearch/js': 4.7.0
      '@docsearch/sidepanel-js': 4.7.0
